...
def run_agent(nepisodes, frozen_states, temperature, gamma_Q, gamma_var,
...
if __name__ == '__main__':
    ...
    outer_dir = os.path.join(outer_dir, "PuddleDiscreteVPAC",  "LRP" + str(args.lr_theta) + "_LRC" + str(args.lr_critic),
                             "Psi" + str(args.psi))
    if not os.path.exists(outer_dir):
        os.makedirs(outer_dir)
    ...
    history, weight_policy, var_return = run_agent(args.nepisodes,
